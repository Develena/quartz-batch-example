package com.hyun.scheduler.demo.config;

import com.hyun.scheduler.demo.properties.QuartzProperties;
...
public class BatchConfiguration {
     ...
     * : 필요한 Bean의 Injection을 Spring에게 위임.
     *
     * @param beanFactory application context beanFactory
     * @return the job factory : Quartz Job Class의 auto-wiring 지원.
     */
    @Bean
